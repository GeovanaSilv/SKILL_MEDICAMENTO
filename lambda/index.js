...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = requestAttributes.t('ENTRADA', requestAttributes.t('SKILL_NAME'));
    const repromptOutput = requestAttributes.t('ENTRADA_REPROMPT');
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = requestAttributes.t('AJUDA');
    const repromptOutput = requestAttributes.t('AJUDA_REPROMPT');
